...
jQuery.fn.extend({
	mopSlider:function(setting){
		...
		if(mopSliderType=="paper"){
			btnLeft.src="includes/JQuery/images/slider.slick/sliderBtnLeftW.png";
			btnLeftF.src="includes/JQuery/images/slider.slick/sliderBtnLeftW_f.png";
			btnRight.src="includes/JQuery/images/slider.slick/sliderBtnRightW.png";
			btnRightF.src="includes/JQuery/images/slider.slick/sliderBtnRightW_f.png";
			btnCenter.src="includes/JQuery/images/slider.slick/sliderBtnW.png";
			btnChange.src="includes/JQuery/images/slider.slick/sliderBackRightRightW.png";
			btnChangeF.src="includes/JQuery/images/slider.slick/sliderBackRightRightW_f.png";
			backImg.src="includes/JQuery/images/slider.slick/paperBack.gif";
			sldcLeftImg.src="includes/JQuery/images/slider.slick/sliderBackLeftLeftW.png";
			sldcRightImg.src="includes/JQuery/images/slider.slick/sliderBackRightRightW.png";
			sldBackLeft.src="includes/JQuery/images/slider.slick/sliderBackLeftW.png";
			sldBackCenter.src="includes/JQuery/images/slider.slick/sliderBackW.png";
			sldBackRight.src="includes/JQuery/images/slider.slick/sliderBackRightW.png";
		}else if(mopSliderType=="black"){
			btnLeft.src="includes/JQuery/images/slider.slick/sliderBtnLeft.png";
			btnLeftF.src="includes/JQuery/images/slider.slick/sliderBtnLeft_f.png";
			btnRight.src="includes/JQuery/images/slider.slick/sliderBtnRight.png";
			btnRightF.src="includes/JQuery/images/slider.slick/sliderBtnRight_f.png";
			btnCenter.src="includes/JQuery/images/slider.slick/sliderBtn.png";
			btnChange.src="includes/JQuery/images/slider.slick/sliderBackRightRight.png";
			btnChangeF.src="includes/JQuery/images/slider.slick/sliderBackRightRight_f.png";
			backImg.src="includes/JQuery/images/slider.slick/monoBack.gif";
			sldcLeftImg.src="includes/JQuery/images/slider.slick/sliderBackLeftLeft.png";
			sldcRightImg.src="includes/JQuery/images/slider.slick/sliderBackRightRight.png";
			sldBackLeft.src="includes/JQuery/images/slider.slick/sliderBackLeft.png";
			sldBackCenter.src="includes/JQuery/images/slider.slick/sliderBack.png";
			sldBackRight.src="includes/JQuery/images/slider.slick/sliderBackRight.png";
		}
		...
		$(mopSliderName+" .indi").css({paddingTop:"2px",fontSize: "10px",textAlign:"center",fontFamily:"Arial, Helvetica, sans-serif",letterSpacing:"0.05em",color:"#2b313e"});
		$(mopSliderName).css({width:mopSliderW+px,/*height:mopSliderH+28+px*/});
		$(mopSliderName).css({position:"relative",overflow:"hidden",margin:"0 auto auto",backgroundColor:"#F8F8F8"/*,backgroundImage:"url("+backImg.src+")"*/});
		...
		if(mopSliderType!="tutorialzine")
		{
			...
			$(mopSliderName+" .leftTopIn").css({height:"10px",width:"10px",backgroundImage:"url(includes/JQuery/images/slider.slick/sliderCorner_leftTop.png)",backgroundRepeat:"no-repeat"});
			$(mopSliderName+" .rightTop").css({height:"10px",width:"10px",position:"absolute",top:"0px",right:"0px"});
			$(mopSliderName+" .rightTopIn").css({height:"10px",width:"10px",backgroundImage:"url(includes/JQuery/images/slider.slick/sliderCorner_rightTop.png)",backgroundRepeat:"no-repeat"});
			$(mopSliderName+" .leftBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",left:"0px"});
			$(mopSliderName+" .leftBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(includes/JQuery/images/slider.slick/sliderCorner_leftBottom.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
			$(mopSliderName+" .rightBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",right:"0px"});
			$(mopSliderName+" .rightBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(includes/JQuery/images/slider.slick/sliderCorner_rightBottom.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
	
			/*logo*/
			$(mopSliderName+" .logo").css({height:"50px",width:"80px",position:"absolute",top:"0px",left:"0px"});
			$(mopSliderName+" .logoIn").css({height:"50px",width:"80px",backgroundImage:"url(includes/JQuery/images/slider.slick/logo.png)",backgroundRepeat:"no-repeat"});
		}
		...
		$(mopSliderName+" .holder").css({marginBottom:'5px',width:holderWidth+"px",height:mopSliderH+px,position:"relative",left:-(scrollMax)+px,cursor:'move'});
