$(function(){
	...
	$('.detail').click(function() {
		var dataApprove = $(this).attr("id");  
		 $("#window_userDetail").load(location.href+" #window_userDetail>*",
			{userid : dataApprove}, 
			 function(){ 
				createWindow0(); 
				//alert(dataApprove);
	...
	function createWindow0(){ 
		if (!dhxWins.window("winFin")) {
			document.getElementById("window_userDetail").style.display = "block";
		...
		winFin.attachObject("window_userDetail");
	} 
