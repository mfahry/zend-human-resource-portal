...
for ($i=0; $i < sizeof($ids); $i++) { 
	...
	switch($mode){
		case "inserted":
			...
			$registry->mTask->insertDB_task($_POST[$rowId."_c0"], $_POST[$rowId."_c1"], $_POST[$rowId."_c2"]);
			$action =  "insert";	
		break;
		case "deleted":
		...
		default:
			...
			$registry->mTask->updateDB_userTask($_POST[$rowId."_c0"], $_POST[$rowId."_c1"], $_POST[$rowId."_c2"]);
