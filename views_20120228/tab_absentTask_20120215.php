...
if($jamPulang != NULL){
	...
	//echo '<div id="html_4">';isset($tab4)?$this->registry->view->show($tab4):'';echo'</div>';
}
...
echo 'tabbar.addTab("a4", "Rekomendasi", "150px");';
//echo 'tabbar.addTab("a5", "Status Rekomendasi", "150px");';
