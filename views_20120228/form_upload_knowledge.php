...
<div id="knowledge" style="display:none; padding:15px;">
  <form action="index.php?mod=knowledge/UploadArtikel" method="post" enctype="multipart/form-data" name="artikel">
    <table>
      ...
      <tr valign="top">
        ...
        <td>:</td>
        <td><textarea name="deskripsi" id="textarea" rows="25" style="width:90%;"></textarea></td>
      </tr>
      <tr valign="top">
...
var winFin = dhxWins.createWindow("w1", 250, 100, 875, 500);
