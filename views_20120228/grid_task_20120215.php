...
<?php
	...
	<table align="center">
        <tr>
			<th width="55" style="text-align:center;" align="center"><b>Prioritas</b></th>
			<th width="400" style="text-align:center;" align="center"><b>Task</b></th>
            <th width="75" style="text-align:center;" align="center"><b>Status (%)</b></th>
			<th width="110" style="text-align:center;" align="center"><b>Target</b></th> 
			<th width="110" style="text-align:center;" align="center"><b>Date</b></th> 
		</tr>
		...
		if(count($tasklist)){
			foreach($tasklist as $data){
				if($data->STATUS < 100){
					echo '<tr>';
					echo '	<td align="center">'.$data->PRIORITY_ID.'</td>';
					echo '	<td align="left">'.$data->TASK.'</td>';
					echo '	<td align="center">'.$data->STATUS.'</td>';
					echo '	<td align="center">'.$data->TARGET.'</td>';						
