...
function detailTask(userid,taskid){
	...
	$("#winDetailTask").dialog({
		...
		hide	: "fold",
		open	: function(){
			//$("#winDetailTask").load("views/window_taskDetail.php?userid="+userid+"&taskid="+taskid);
			$.ajax({
				type: "POST",
...
<?php
		...
		?>       
	<table id="gridbox" align="center" width="<?php echo ($url[0]=="reporting"? "750":"635");?>">
        ...
        <tr>
            ...
            <?php if(($url[0]=='reporting')){ ?>
				<td width="110" style="text-align:center;" align="center">Posted Date</td>
             <?php } ?>
		</tr>
