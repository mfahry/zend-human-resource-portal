...
?>
<table id="feedback"  style="border:1px solid #ccc;clear:both;width:600px;float:left;" class="ui-widget ui-widget-content ui-corner-all">
	<tr>
...
?>
	<tr>
        ...
        <td style="border:1px solid #ccc;text-align:center;" ><?php if ($fbstat==0) { echo "Unread"; }else{ echo "Done";}?></td>
        <?php
		if((isset($_SESSION['level_id'])) &&  ($_SESSION['level_id']==2)){
		?>
