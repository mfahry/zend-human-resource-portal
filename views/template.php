...
<?php }else{?>
<div class="content">
  <div id="main" style="vertical-align:middle; padding-top:10px; padding-bottom:7px; background-color:#000000; text-align:center"> <img src="<?php echo IMG_PATH;?>DoExtremely.jpg"  width="940" /> </div>
</div>
<?php } ?>
<div class="content">
  <div id="main">
