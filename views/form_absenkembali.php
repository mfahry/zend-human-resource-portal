...
<br>
<form method="post" name="frmAttendanceBackY" id="frmAttendanceBackY" action="index.php?mod=attendance/backToOffice">
  <table style="margin:15px;">
    <tr>
      <td colspan="3" class="alertRed">Kemarin Anda tidak menginputkan Absensi Kembali Anda!</td>
    </tr>
    <tr>
      <td colspan="3"><label>Absensi kembali ke kantor anda  :</label></td>
    </tr>
    <?php
			$k=1;
